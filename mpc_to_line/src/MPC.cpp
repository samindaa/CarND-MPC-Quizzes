...
int main() {
  ...
  // tmp sol
  std::ofstream ofs_cte_vals("/tmp/cte_vals"), ofs_delta_vals("/tmp/delta_vals"), ofs_v_vals("/tmp/v_vals");
  for (auto& v : cte_vals) {
    ofs_cte_vals << v << std::endl;
  }
  for (auto& v : delta_vals) {
    ofs_delta_vals << v << std::endl;
  }
  for (auto& v : v_vals) {
    ofs_v_vals << v << std::endl;
  }
